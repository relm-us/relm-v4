...
const EMISSIVE_NO_EMISSION_COLOR = new Color(0x000000)
const EMISSIVE_DEFAULT_COLOR = new Color(0x666600)
...
const HasEmissiveMaterial = stampit(Component, {
  ...
  methods: {
    ...
    applyEmissive() {
      const color = this._emissive
        ? this._emissiveColor
        : EMISSIVE_NO_EMISSION_COLOR
