...
var SkeletonUtils = {
  ...
  clone: function (source) {
    ...
    clone.traverse(function (node) {
      ...
      // ADDED by Duane: Clone the material as well, so that it can be independently
      // colored and opacity can be set for each SkinnedMesh:
      var clonedMeshMaterial = clonedMesh.material.clone()
      clonedMesh.material = clonedMeshMaterial
